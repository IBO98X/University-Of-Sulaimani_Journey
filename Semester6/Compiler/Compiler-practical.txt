...
public class FinalExam {
    public static void main(String[] args) {
        ...
        // FileReader("C:\\UniverstyProjects\\Compiler\\temp.txt");
        ...
        Matcher m = p.matcher("131Compiler232Computation7876Lectures");
        while (m.find()) {
            System.out.println("Start : " + m.start() + " End : " + (m.end() - 1));
        }
        System.out.println(m.replaceAll("_"));
        String text = m.replaceAll("_");
